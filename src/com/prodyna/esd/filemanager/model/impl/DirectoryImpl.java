...
public class DirectoryImpl extends FileSystemElementImpl implements Directory {
	...
	/**
	 * To create a directory implementation please use {@link FileSystemFactoryImpl#createDirectory(String, Directory)}.
	 ...
	 * @param elements
	 */
	public DirectoryImpl(String name, Directory parent, List<FileSystemElement> elements) {
		super(name, parent);
	 ...
	 * @param fileSystemElement file element to add.
	 */
	@Override
	public
	 ...
	 * @param fileSystemElement element to remove.
	 */
	@Override
	public
	...
	/* (non-Javadoc)
	 * @see com.prodyna.esd.filemanager.visitor.Visitable#accept(com.prodyna.esd.filemanager.visitor.Visitor)
	 */
	@Override
